    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            PrimOp::Int(op) => match op {
                ...
                super::prim::IntOp::Div => write!(f, "int.div"),
                super::prim::IntOp::Mod => write!(f, "int.mod"),
                super::prim::IntOp::SubSat => write!(f, "int.sub_sat"),
                super::prim::IntOp::Le  => write!(f, "int.le"),
                super::prim::IntOp::And => write!(f, "int.and"),
                super::prim::IntOp::Or  => write!(f, "int.or"),
                super::prim::IntOp::Xor => write!(f, "int.xor"),
                super::prim::IntOp::Shl => write!(f, "int.shl"),
                super::prim::IntOp::Shr => write!(f, "int.shr"),
            },
